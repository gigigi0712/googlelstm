...
class HandoffForecastLSTMHourly(BaseModel):
    ...
    def __init__(self, cfg: Config):
        super(HandoffForecastLSTMHourly, self).__init__(cfg=cfg)

        self.initial_hindcast_seq_length = self.cfg.seq_length['1h'] - self.cfg.forecast_seq_length
