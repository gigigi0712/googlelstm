...
# from cudalstm.model.cudalstm import CudaLSTM
...
from googlelstm.model.handoff_forecast_lstm import HandoffForecastLSTM
from googlelstm.model.handoff_forecast_lstm_hourly import HandoffForecastLSTMHourly
...
from neuralhydrology.modelzoo.gumbelmoelstm import GumbelMoeLSTM
# from neuralhydrology.modelzoo.crossbeforelstm import CrossBeforeLstm
from crosslstm.model.crossbeforelstm import CrossBeforeLstm
...
def get_model(cfg: Config) -> nn.Module:
    ...
    elif cfg.model.lower() == "handoff_forecast_lstm_hourly":
        model = HandoffForecastLSTMHourly(cfg=cfg)
    ...
    elif cfg.model.lower() == "crosslstm":
        model = CrossBeforeLstm(cfg=cfg)
    elif cfg.model.lower() == "gumbelmoelstm":
        model = GumbelMoeLSTM(cfg=cfg)
    else:
