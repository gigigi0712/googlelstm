...
def main():
    ...
    # 从文件中读取站点ID
    station_ids = read_station_ids("531_basin_list.txt")  # 假设文件名为 "1_danube_basin.txt"

    # 创建存储图像的文件夹
    img_folder = Path("E:/DL/code/Neuralhydrology/neuralhydrology-modelzoo/cudalstm_project/results/Camelus_531_streamflow")
    ...
    # 路径设置
    run_dir = Path("runs/cudalstm_531_basins_streamflow_exp1_2702_162415")
    ...
    # 保存为 Excel 文件
    accuracy_df.to_excel("E:/DL/code/Neuralhydrology/neuralhydrology-modelzoo/cudalstm_project/results/Camelus_531_streamflow_newsplit_exp1_all_accuracy_and_nse_results.xlsx", index=False)
