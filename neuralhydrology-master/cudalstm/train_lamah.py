...
def main():
    ...
    if torch.cuda.is_available():
        start_run(config_file=Path("caravan_grdc_5670_basins_runoff_debug_exp1.yml"))

    # fall back to CPU-only mode
    else:
        start_run(config_file=Path("caravan_grdc_5670_basins_runoff_debug_exp1.yml"), gpu=-1)
