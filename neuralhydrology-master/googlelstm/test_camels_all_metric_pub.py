...
def main():
    ...
    # 从文件中读取站点ID
    station_ids = read_station_ids("caravan_531_basin_list.txt")  # 假设文件名为 "1_danube_basin.txt"
    ...
    # 路径设置
    run_dir = Path("runs/grdc_basins_W365L1_regression_runoff_exp1_0603_174850")
    eval_run(run_dir=run_dir, period="test", epoch=20)
    ...
    # 保存为 Excel 文件
    accuracy_df.to_excel("E:/DL/code/Neuralhydrology/neuralhydrology-modelzoo/googleLstmproject/results/Caravan_camels531_pub_runoff_exp1_all_accuracy_and_nse_results.xlsx", index=False)
