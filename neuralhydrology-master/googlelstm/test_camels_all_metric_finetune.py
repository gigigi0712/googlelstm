...
def main():
    ...
    # 路径设置
    run_dir = Path("runs/grdc_basins_W365L1_regression_runoff_finetune_exp2_1003_092900")
    ...
    # 保存为 Excel 文件
    accuracy_df.to_excel("E:/DL/code/Neuralhydrology/neuralhydrology-modelzoo/googleLstmproject/results/Caravan_camels531_finetune_runoff_exp2_all_accuracy_and_nse_results.xlsx", index=False)
