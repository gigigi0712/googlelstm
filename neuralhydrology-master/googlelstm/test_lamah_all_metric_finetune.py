...
def main():
    ...
    # 从文件中读取站点ID
    station_ids = read_station_ids("lamah.txt")  # 假设文件名为 "1_danube_basin.txt"

    # 创建存储图像的文件夹
    img_folder = Path("/home/dalhxwlyjsuo/criait_gaozy/google/neuralhydrology-master/neuralhydrology-master/googlelstm/results/lamah_W365L1_531_runoff")
    ...
    # 路径设置
    run_dir = Path("runs/grdc_lamah_W365L1_regression_runoff_finetune_exp1_1403_091414")
    ...
    # 保存为 Excel 文件
    accuracy_df.to_excel("/home/dalhxwlyjsuo/criait_gaozy/google/neuralhydrology-master/neuralhydrology-master/googlelstm/results/grdc_lamah149_finetune_runoff_exp1_all_accuracy_and_nse_results.xlsx", index=False)
