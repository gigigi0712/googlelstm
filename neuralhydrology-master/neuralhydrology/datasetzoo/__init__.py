...
from neuralhydrology.datasetzoo.yellowriver import YellowRiver
from neuralhydrology.datasetzoo.grdc import GRDC
...
def get_dataset(cfg: Config,
    ...
    if cfg.dataset.lower() == "camels_us":
        ...
        Dataset = Caravan
    elif cfg.dataset.lower() == "yellow_river":
        Dataset = YellowRiver
    elif cfg.dataset.lower() == "grdc":
        Dataset = GRDC
    else:
